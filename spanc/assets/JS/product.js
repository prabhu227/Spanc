...
<<<<<<< HEAD
      ...
      },
      {
        ...
        link: "./products-page/plus3-physics-equipment/fly-wheel-apparatus.html",
        model: "SPML-003",
        image: "./assets/images/+3image/flywheel.png",
      },
      {
        title: "Optical Lever Apparatus",
        link: "./products-page/plus3-physics-equipment/optical-lever-apparatus.html",
        model: "SPML-004",
        image: "./assets/images/+3image/opticalbeach.png",
      },
      {
        title: "Maxwell Needle",
        link: "./products-page/plus3-physics-equipment/maxwell-needel.html",
        model: "SPML-005",
      ...
      // { title: "Searle's Method (Basic)", link: "./products-page/plus3-physics-equipment/searle-basic-method.html",model:"SPML-006" },
      {
        ...
        link: "./products-page/plus3-physics-equipment/searle-digital-method.html",
        model: "SPML-006",
        image: "./assets/images/+3image/searls1.png",
      },
      {
        title: "Searle's Method (Elastic Constants)",
        link: "./products-page/plus3-physics-equipment/searle-elastic-method.html",
        model: "SPML-006A",
      ...
      // { title: "Searle's Method A", link: "./products-page/plus3-physics-equipment" },
      {
        ...
        link: "./products-page/plus3-physics-equipment/bar-pendulum-advance.html",
        model: "SPML-007A",
        image: "./assets/images/+3image/barpendulumk.png",
      },
      {
        title: "Bar Pendulum (Basic)",
        link: "./products-page/plus3-physics-equipment/bar-pendulum-basic.html",
        model: "SPML-007B",
        image: "./assets/images/+3image/barpendulunbasic.png",
      },
      {
        title: "Bar Pendulum (Digital Counter)",
        link: "./products-page/plus3-physics-equipment/bar-pendulum-digital.html",
        model: "SPML-007D",
        image: "./assets/images/+3image/bardigital.png",
      },
      {
        title: "Kater's Pendulum (Advance)",
        link: "./products-page/plus3-physics-equipment/kater-pendulum-advance.html",
        model: "SPML-008A",
        image: "./assets/images/+3image/katerpendulum.png",
      },
      {
        title: "Kater's Pendulum (Basic)",
        link: "./products-page/plus3-physics-equipment/kater-pendulum-basic.html",
        model: "SPML-008B",
        image: "./assets/images/+3image/katerbasic.png",
      },
      {
        title: "Kater's Pendulum (Digital)",
        link: "./products-page/plus3-physics-equipment/kater-pendulum-digital.html",
        model: "SPML-008D",
        image: "./assets/images/+3image/katerdigital.png",
      },
      {
        title: "Spring Constant Apparatus",
        link: "./products-page/plus3-physics-equipment/spring-constant.html",
        model: "SPML-009",
        image: "./assets/images/+3image/spring.png",
      },
      {
        title: "Poiseuille's Method",
        link: "./products-page/plus3-physics-equipment/poiseille-method.html",
        model: "SPML-010",
        image: "./assets/images/+3image/stock.png",
      },
      {
        title: "Barton Apparatus (Horizontal)",
        link: "./products-page/plus3-physics-equipment/bartonapp-horizontal.html",
        model: "SPML-011H",
        image: "./assets/images/+3image/rigity.png",
      },
      {
        title: "Barton Apparatus (Vertical)",
        link: "./products-page/plus3-physics-equipment/bartonapp-vertical.html",
        model: "SPML-011V",
        image: "./assets/images/+3image/rigitvertical.png",
      },
      {
        title: "Bending of Beam (Double)",
        link: "./products-page/plus3-physics-equipment/bendingofbeam-double.html",
        model: "SPML-012",
        image: "./assets/images/+3image/bendingbean.png",
      },
      {
        title: "Bending of Beam (Single)",
        link: "./products-page/plus3-physics-equipment/bendingofbeam-single.html",
        model: "SPML-012",
        image: "./assets/images/+3image/bendingbeansingle.png",
      },
      {
        title: "Sonometer (Basic)",
        link: "./products-page/plus3-physics-equipment/sonometer-basic.html",
        model: "SPML-013B",
        image: "./assets/images/+3image/sonometerbasic.png",
      },
      {
        title: "Sonometer (Electric)",
        link: "./products-page/plus3-physics-equipment/sonometer-electric.html",
        model: "SPML-013E",
        image: "./assets/images/+3image/sonometerelectric.png",
      },
      {
        title: "Young's Modulus of Rubber",
        link: "./products-page/plus3-physics-equipment/youngmodulus.html",
        model: "SPML-014",
        image: "./assets/images/+3image/youngmodulesrubber.png",
      },
      {
        title: "Magnifying Power of Telescope",
        link: "./products-page/plus3-physics-equipment/magnifyingpower.html",
        model: "SPML-015",
        image: "./assets/images/+3image/magnifying.png",
      },
      {
        title: "Radius of Curvature of Concave/Convex Mirror",
        link: "./products-page/plus3-physics-equipment/radiusofconcave-convex.html",
        model: "SPML-016",
        image: "./assets/images/+3image/convec.png",
      },
      {
        title: "Simple Pendulum",
        link: "./products-page/plus3-physics-equipment/simple-pendulum.html",
        model: "SPML-017",
        image: "./assets/images/+3image/simple.png",
      },
      {
        title: "Lami's Theorem",
        link: "./products-page/plus3-physics-equipment/lami-theorem.html",
        model: "SPML-018",
        image: "./assets/images/+3image/limstheorum.png",
      },
      {
        title: "Stoke's Apparatus",
        link: "./products-page/plus3-physics-equipment/stokeapp.html",
        model: "SPML-019",
        image: "./assets/images/+3image/stock.png",
      },
      {
        title: "Optical Bench",
        link: "./products-page/plus3-physics-equipment/opticalbench.html",
        model: "SPML-020",
        image: "./assets/images/+3image/opticalbeach.png",
      },
      {
        title: "Half Deflection Method & Figure of Merit",
        link: "./products-page/plus3-physics-equipment/half-deflectionmethod.html",
        model: "SPML-021",
...
>>>>>>> e1be3b4c052cf54336f05f672b4a4db93c1a62ca
  },
  {
    category: "emLab",
...
<<<<<<< HEAD
      {
        ...
        link: "./products-page/plus3-physics-equipment/callander-barnes-advanced.html",
        model: "TPSM-001A",
        image: "./assets/images/+3image/TPSM-001A.png",
      },
      {
        title: "Callander Barnes Apparatus (Basic)",
        link: "./products-page/plus3-physics-equipment/callander-barnes-basic.html",
        model: "TPSM-001B",
        image: "./assets/images/+3image/TPSM-001B.png",
      },
      {
        title: "Planck's Constant Using LED",
        link: "./products-page/plus3-physics-equipment/plancks-constant-led.html",
        model: "TPSM-002",
        image: "./assets/images/+3image/TPSM-002.png",
      },
      {
        title: "Stefan Constant Using Bulb",
        link: "./products-page/plus3-physics-equipment/stefan-constant-bulb.html",
        model: "TPSM-003",
        image: "./assets/images/+3image/TPSM-003.png",
      },
      {
        title: "Thermal Conductivity of Cu by Searle's Apparatus",
        link: "./products-page/plus3-physics-equipment/searles-apparatus-cu.html",
        model: "TPSM-004",
        image: "./assets/images/+3image/TPSM-004.png",
      },
      {
        title: "Lee's Disc",
        link: "./products-page/plus3-physics-equipment/lees-disc.html",
        model: "TPSM-005",
        image: "./assets/images/+3image/TPSM-005.png",
      },
      {
        title: "PRT (Platinum Resistance Thermometer)",
        link: "./products-page/plus3-physics-equipment/prt-platinum-thermometer.html",
        model: "TPSM-006",
        image: "./assets/images/+3image/TPSM-006.png",
      },
      {
        title: "Method of Cooling",
        link: "./products-page/plus3-physics-equipment/method-of-cooling.html",
        model: "TPSM-007",
        image: "./assets/images/+3image/TPSM-007.png",
      },
      {
        title: "Thermo EMF Across Two Junctions",
        link: "./products-page/plus3-physics-equipment/thermo-emf-junctions.html",
        model: "TPSM-008",
        image: "./assets/images/+3image/TPSM-008.png",
      },
      {
        title: "Electrochemical Equivalent (ECE) of Copper",
        link: "./products-page/plus3-physics-equipment/ece-of-copper.html",
        model: "TPSM-011",
...
<<<<<<< HEAD
      {
        ...
        link: "./products-page/plus3-physics-equipment/coupled-oscillation.html",
        model: "FE-111",
        image:"./assets/images/+3image/FE-111.png",
      },
      {
        title: "Melde's Apparatus",
        link: "./products-page/plus3-physics-equipment/meldes-apparatus.html",
        model: "WO-001",
        image:"./assets/images/+3image/WO-001.png",
      },
      {
        title: "Lissajous Figures",
        link: "./products-page/plus3-physics-equipment/lissajous-figures.html",
        model: "WO-002",
        image:"./assets/images/+3image/WO-002.png",
      },
      {
        title: "Wedge Shaped Film",
        link: "./products-page/plus3-physics-equipment/wedge-shaped-film.html",
        model: "WO-003",
        image:"./assets/images/+3image/WO-003.png",
      },
      {
        title: "He-Ne Laser Experiment",
        link: "./products-page/plus3-physics-equipment/he-ne-laser.html",
        model: "WO-004",
        image:"./assets/images/+3image/WO-004.png",
      },
      {
        title: "Cauchy's Constant",
        link: "./products-page/plus3-physics-equipment/cauchy-constant.html",
        model: "WO-005",
        image:"./assets/images/+3image/WO-005.png",
      },
      {
        title: "Newton's Rings (Basic)",
        link: "./products-page/plus3-physics-equipment/newtons-rings-basic.html",
        model: "WO-006B",
        image:"./assets/images/+3image/WO-006B.png",
      },
      {
        title: "Newton's Rings (Digital)",
        link: "./products-page/plus3-physics-equipment/newtons-rings-digital.html",
        model: "WO-006D",
        image:"./assets/images/+3image/WO-006D.png",
      },
      {
        title: "Fresnel Biprism",
        link: "./products-page/plus3-physics-equipment/fresnel-biprism.html",
        model: "WO-007",
        image:"./assets/images/+3image/WO-007.png",
      },
      {
        title: "Michelson Interferometer with Sodium Light",
        link: "./products-page/plus3-physics-equipment/michelson-interferometer-sodium.html",
        model: "WO-010",
        image:"./assets/images/+3image/WO-010.png",
      },
      {
        title: "Travelling Microscope",
        link: "./products-page/plus3-physics-equipment/travelling-microscope.html",
        model: "WO-011",
...
>>>>>>> e1be3b4c052cf54336f05f672b4a4db93c1a62ca
  },
  {
    ...
    viewMoreLink: "./products-page/digital-system.html",
    products: [
<<<<<<< HEAD
      {
        title: "DIgital",
        link: "./products-page/plus3-physics-equipment/digital.html",
        model: "",
      },
      {
        title: "NOT Gate Using Transistor",
        link: "./products-page/plus3-physics-equipment/not-gate-transistor.html",
        model: "DAS-001",
      ...
      },
      {
        ...
        link: "./products-page/plus3-physics-equipment/basic-logic-gate.html",
        model: "DIL-001B",
        image: "./assets/images/+3image/DIL-001B.png",
      },
      {
        title: "Universal Gate - NAND Gate",
        link: "./products-page/plus3-physics-equipment/universal-gate-nand.html",
        model: "DAS-002",
        image: "./assets/images/+3image/DAS-002.png",
      },
      {
        title: "Convert Boolean Expression into Logic Circuit",
        link: "./products-page/plus3-physics-equipment/boolean-expression-to-logic-circuit.html",
        model: "DIL-003",
        image: "./assets/images/+3image/DIL-003.png",
      },
      {
        title: "Adder & Subtractor Using Logic Gates",
        link: "./products-page/plus3-physics-equipment/adder-subtractor-logic-gates.html",
        model: "DIL-004",
        image: "./assets/images/+3image/DIL-004.png",
      },
      {
        title: "Astable & Monostable Multivibrator Using 555 Timer",
        link: "./products-page/plus3-physics-equipment/multivibrator-555-timer.html",
        model: "DIL-005",
      ...
      },
      {
        ...
        link: "./products-page/plus3-physics-equipment/flip-flop-nand-gates.html",
        model: "DAS-006",
        image: "./assets/images/+3image/DAS-006.png",
      },
      {
        title: "JK Master Slave Flip-Flop Using Flip-Flop IC",
        link: "./products-page/plus3-physics-equipment/jk-master-slave-flip-flop.html",
        model: "DSA-007",
        image: "./assets/images/+3image/DSA-007.png",
      },
      {
        title: "4-Bit Counter Using D-Type, JK Flip-Flop IC",
        link: "./products-page/plus3-physics-equipment/4bit-counter-flip-flop.html",
        model: "DSA-008A",
      ...
      },
      {
        ...
        link: "./products-page/plus3-physics-equipment/4bit-shift-register.html",
        model: "DSA-008B",
        image: "./assets/images/+3image/DSA-008B.png",
      },
      {
        title: "Analog & Digital Trainer Kit",
        link: "./products-page/plus3-physics-equipment/analog-digital-trainer-kit.html",
        model: "DSA-009",
...
<<<<<<< HEAD
      {
        title: "Vacuum Diode",
        link: "./products-page/plus3-physics-equipment/vacuum-diode.html",
        model: "EMP-001",
      },
      {
        title: "Planck's Constant Using LED",
      ...
      },
      {
        ...
        link: "./products-page/plus3-physics-equipment/h-alpha-hydrogen.html",
        model: "EMP-003",
      },
      {
        title: "Ionization Potential of Mercury",
        link: "./products-page/plus3-physics-equipment/ionization-potential-mercury.html",
        model: "EMP-004",
      },
      {
        title: "Iodine Vapour Spectrum",
        link: "./products-page/plus3-physics-equipment/iodine-vapour.html",
        model: "EMP-005",
      },
      {
        title: "e/m by Magnetic Focusing",
        link: "./products-page/plus3-physics-equipment/em-magnetic-focusing.html",
        model: "EMP-006",
      },
      {
        title: "e/m by Bar Magnet",
        link: "./products-page/plus3-physics-equipment/em-bar-magnet.html",
        model: "EMP-007",
      },
      {
        title: "Millikan Oil Drop Apparatus",
        link: "./products-page/plus3-physics-equipment/millikan-oil-drop.html",
        model: "EMP-008",
      },
      {
        title: "Tunnel Diode Apparatus",
        link: "./products-page/plus3-physics-equipment/tunnel-diode.html",
        model: "EMP-009",
      },
      {
        title: "Diode Laser: Grating",
        link: "./products-page/plus3-physics-equipment/diode-laser-grating.html",
        model: "EMP-010A",
      },
      {
        title: "Diode Laser: Single & Double Slit",
        link: "./products-page/plus3-physics-equipment/diode-laser-slits.html",
        model: "EMP-010B",
      },
      // { title: "He-Ne Laser: Single & Double Slit", link: "./products-page/plus3-physics-equipment/he-ne-laser-slits.html", model: "EMP-010HN" },
      {
        ...
        link: "./products-page/plus3-physics-equipment/photoelectric-effect.html",
        model: "EMP-012",
      },
    ],
=======
...
<<<<<<< HEAD
      {
        ...
        link: "./products-page/plus3-physics-equipment/pn-junction-forward-reverse.html",
        model: "ASP-001A",
      },
      {
        title: "PN Junction - Boltzmann Constant Determination",
        link: "./products-page/plus3-physics-equipment/pn-junction-boltzmann-constant.html",
        model: "ASP-001D",
      },
      {
        title: "Zener Diode as Voltage Regulator",
        link: "./products-page/plus3-physics-equipment/zener-diode-voltage-regulator.html",
        model: "ASP-002",
      },
      {
        title: "Zener Diode Characteristics",
        link: "./products-page/plus3-physics-equipment/zener-diode-characteristics.html",
        model: "ASP-002B",
      },
      {
        title: "Solar Cell Characteristics",
        link: "./products-page/plus3-physics-equipment/solar-cell.html",
        model: "ASP-003",
      },
      {
        title: "Solar Cell (Alternate Version)",
        link: "./products-page/plus3-physics-equipment/solar-cell-detailed.html",
        model: "ASP-003D",
      },
      {
        title: "Transistor Characteristics - PNP & NPN",
        link: "./products-page/plus3-physics-equipment/transistor-pnp-npn.html",
        model: "ASP-004",
      },
      {
        title: "RC Coupled Amplifier",
        link: "./products-page/plus3-physics-equipment/rc-coupled-amplifier.html",
        model: "ASP-006",
      },
      {
        title: "Wein Bridge Oscillator using Op-Amp",
        link: "./products-page/plus3-physics-equipment/wein-bridge-oscillator.html",
        model: "ASP-007",
      },
      {
        title: "LED - Forward & Reverse Bias",
        link: "./products-page/plus3-physics-equipment/led-forward-reverse.html",
        model: "ASP-008",
      },
      {
        title: "Colpitt's Oscillator",
        link: "./products-page/plus3-physics-equipment/colpitts-oscillator.html",
        model: "ASP-009",
      },
      {
        title: "Op-Amp - Inverting & Non-Inverting",
        link: "./products-page/plus3-physics-equipment/opamp-inverting-noninverting.html",
        model: "ASP-012",
      },
      {
        title: "Op-Amp - Integrator & Differentiator",
        link: "./products-page/plus3-physics-equipment/opamp-integrator-differentiator.html",
        model: "ASP-017",
      },
      {
        title: "Ohm's Law Experiment",
        link: "./products-page/plus3-physics-equipment/ohms-law.html",
        model: "ASP-018",
      },
    ],
=======
...
<<<<<<< HEAD
      {
        ...
        link: "./products-page/plus3-physics-equipment/dielectric-constant-frequency.html",
        model: "SSP-000",
      },
      {
        title: "Dielectric Constant (SCS Method)",
        link: "./products-page/plus3-physics-equipment/dielectric-constant-scs.html",
        model: "SSP-000B",
      },
      {
        title: "Quincke's Tube",
        link: "./products-page/plus3-physics-equipment/quinckes-tube.html",
        model: "SSP-001",
      },
      {
        title: "Gouy's Method",
        link: "./products-page/plus3-physics-equipment/gouys-method.html",
        model: "SSP-002",
      },
      {
        title: "Dielectric Constant (Solid State)",
        link: "./products-page/plus3-physics-equipment/dielectric-constant-solid.html",
        model: "SSP-004",
      },
      {
        title: "B-H Curve Setup",
        link: "./products-page/plus3-physics-equipment/bh-curve.html",
        model: "SSP-006",
      },
      {
        title: "Four Probe Method",
        link: "./products-page/plus3-physics-equipment/four-probe-method.html",
        model: "SSP-007",
      },
      {
        title: "Hall Effect",
        link: "./products-page/plus3-physics-equipment/hall-effect.html",
        model: "SSP-008",
      },
=======
